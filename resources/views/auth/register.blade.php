        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                            ...
                            <select name="role_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                ...
                                <option value="foreign_tourist">Foreign Tourist</option>
                                <option value="native_tourist">Native Tourist</option>
                                <option value="tourist_police">Tourist Police</option>
                                <option value="tourist_police_si">Tourist Police SI</option>
                            </select>
                        </div>
